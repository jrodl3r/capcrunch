      ...
      return (
        <div id={id} className="tile active"
          ...
          <div id={player.id} data-group={player.group} className="player active hover" draggable="true"
            ...
            <div className="inner">
              { !altLine ? <img height="48" width="48" src={ player.image ? 'http://s3.amazonaws.com/capcrunch/168x168/' + player.image : 'http://s3.amazonaws.com/capcrunch/img/default.png' }/> : null }
              <div className="info">
